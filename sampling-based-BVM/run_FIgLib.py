...
dataset_path = '/home/users/u5155914/projects/FIgLib'
gt_path = '/home/users/u5155914/projects/SMOKE5K/test/gt_/'
...
test_datasets = ['']
test_datasets = glob.glob(os.path.join(dataset_path, "*"))
test_datasets = [os.path.basename(case) for case in test_datasets]
print(test_datasets)

pre_root = './results_FIgLib/'
for dataset in test_datasets:
    save_path = os.path.join(pre_root, dataset) + "/"
    ...
    for i in tqdm(range(test_loader.size)):
        ...
        if os.path.exists(save_path_sal + name):
            continue
